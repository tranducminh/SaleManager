...
var getDllName_1 = require("./getDllName");
...
var spawnServer = function (cwd, args, options, logger) {
    server = child_process_1.spawn('node', args.slice(), {
        stdio: [0, 1, 2],
        cwd: cwd,
        env: __assign({}, process.env, { LAST_EXIT_CODE: "" + lastExitCode })
    });
    logger.info("Spawning " + ['node'].concat(args).join(' ') + ", env: { LAST_EXIT_CODE: " + lastExitCode + " }");
...
var webpackReporter = function (zen, builder, outputPath, log, err, stats) {
    if (err) {
        log.error(err.stack);
...
var startClientWebpack = function (hasBackend, zen, builder) {
    var _a;
    ...
    try {
        var reporter = function () {
            ...
            return webpackReporter.apply(void 0, [zen, builder, configOutputPath, logger].concat(args));
        };
        if (zen.watch) {
...
var startServerWebpack = function (zen, builder) {
    var config = builder.config;
    var logger = minilog(config.name + "-webpack");
    if (builder.silent) {
        logger.suggest.deny(/.*/, 'debug');
    ...
    try {
        ...
        var reporter = function () {
            ...
            return webpackReporter.apply(void 0, [zen, builder, config.output.path, logger].concat(args));
        };
        var compiler = webpack(config);
        if (zen.watch) {
                    ...
                    if (server) {
                        ...
                        if (builder.frontendRefreshOnBackendChange) {
                            for (var _i = 0, _a = stats.compilation.modules; _i < _a.length; _i++) {
                                var module_1 = _a[_i];
                                if (module_1.built && module_1.resource && module_1.resource.indexOf('server') >= 0) {
...
var openFrontend = function (zen, builder, logger) {
    var opn = builder.require.probe('opn') ? builder.require('opn') : null;
    try {
...
var startWebpackDevServer = function (hasBackend, zen, builder, reporter, logger) {
    var webpack = builder.require('webpack');
    var config = builder.config;
    ...
    if (builder.webpackDll && builder.child) {
        var name = getDllName_1.default(builder);
...
var isDllValid = function (zen, builder, logger) {
    var name = getDllName_1.default(builder);
    try {
...
var buildDll = function (zen, builder) {
    var webpack = builder.require('webpack');
...
var setupExpoDir = function (zen, builder, dir, platform) {
    ...
    var appJson = JSON.parse(fs.readFileSync(builder.require.resolve('./app.json'), 'utf8'));
    [
        'expo.icon',
        'expo.ios.icon',
        'expo.android.icon',
...
var startExpoServer = function (zen, builder, projectRoot, packagerPort) { return __awaiter(_this, void 0, void 0, function () {
...
var launchExpoApp = function (builder, platform, logger) { return __awaiter(_this, void 0, void 0, function () {
    var _a, UrlUtils, Android, Simulator, qr, projectRoot, address, localAddress, _b, success, error, _c, success, msg;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                ...
                if (!!isDocker()) return [3, 6];
                if (!(platform === 'android' || platform === 'all')) return [3, 4];
            ...
            case 3:
                ...
                _d.label = 4;
            case 4:
                if (!(platform === 'ios' || platform === 'all')) return [3, 6];
...
var startExpoProject = function (zen, builder, logger) { return __awaiter(_this, void 0, void 0, function () {
    var platform, projectRoot, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, startExpoServer(zen, builder, projectRoot, builder.config.devServer.port)];
            case 2:
                _a.sent();
                return [4, launchExpoApp(builder, platform, logger)];
            case 3:
                _a.sent();
                return [3, 5];
            case 4:
...
var startWebpack = function (zen, builder, platforms) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
var startExpoProdServer = function (zen, mainBuilder, builders, expCmd, logger) { return __awaiter(_this, void 0, void 0, function () {
    var connect, mime, compression, statusPageMiddleware, UrlUtils, packagerPort, app, serverInstance, projectRoot, address;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                return [4, startExpoServer(zen, mainBuilder, projectRoot, packagerPort)];
            case 2:
                _a.sent();
                if (!(expCmd === 'server')) return [3, 4];
                return [4, launchExpoApp(mainBuilder, 'all', logger)];
            case 3:
                _a.sent();
                return [3, 6];
            case 4: return [4, UrlUtils.constructManifestUrlAsync(projectRoot)];
            case 5:
                address = _a.sent();
...
var startExp = function (zen, builders, logger) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, startExpoProdServer(zen, mainBuilder, builders, process.argv[expIdx + 1], logger)];
            case 1:
                _b.sent();
                _b.label = 2;
            case 2:
...
var runBuilder = function (cmd, builder, platforms) {
    ...
    var zen = new Zen_1.default(builder.require.cwd, cmd);
    if (builder.stack.hasAny('webpack')) {
        var prepareDllPromise = zen.watch && builder.webpackDll && builder.child ? buildDll(zen, builder) : Promise.resolve();
        prepareDllPromise.then(function () { return startWebpack(zen, builder, platforms); });
    }
    else {
        throw new Error("builder '" + builder.name + "' stack does not include 'webpack'. Consider let zen guess your stack by removing 'stack' propery.");
    }
};
var execute = function (cmd, argv, builders, zen) {
    var expoPlatforms = [];
    var platforms = {};
        ...
        if (cmd === 'exp') {
            ...
            for (var _i = 0, _a = Object.keys(builders); _i < _a.length; _i++) {
                ...
                if (builder.roles.indexOf('test') >= 0) {
                    var testArgs = ['--webpack-config', builder.require.resolve('@larix/zen/webpack.config.js')];
                    ...
                    var haveMochapack = builder.require.probe('mochapack');
                    ...
                    var mochapackCmd = haveMochapack ? 'mochapack' : 'mocha-webpack';
                    var testCmd = path.join(process.cwd(), 'node_modules/.bin/' + mochapackCmd + (__WINDOWS__ ? '.cmd' : ''));
            ...
            var prepareExpoPromise = zen.watch && expoPlatforms.length > 0 ? allocateExpoPorts(expoPlatforms) : Promise.resolve();
