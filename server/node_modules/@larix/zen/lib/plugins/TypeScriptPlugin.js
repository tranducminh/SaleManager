...
var TypeScriptPlugin = (function () {
    ...
    TypeScriptPlugin.prototype.configure = function (builder, zen) {
        ...
        if (stack.hasAll(['ts', 'webpack'])) {
            ...
            if (!!builder.require.probe('ts-loader')) {
                ...
                tsLoaderOpts = zen.createConfig(builder, 'tsLoader', __assign({ transpileOnly: tsChecker ? true : false, happyPackMode: parallelLoader_1.hasParallelLoalder(builder) ? true : false }, builder.tsLoaderOptions));
                if (tsLoaderVer > 33) {
            ...
            tsRule.test = /\.ts$/;
            tsRule.use = parallelLoader_1.addParalleLoaders(builder, zen, [
                atl
                    ? {
                        loader: 'awesome-typescript-loader',
                        options: zen.createConfig(builder, 'awesomeTypescript', __assign({}, builder.tsLoaderOptions, { useCache: true }))
                    }
                    : {
                        loader: 'ts-loader',
