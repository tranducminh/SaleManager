...
var CssProcessorPlugin = (function () {
    ...
    CssProcessorPlugin.prototype.configure = function (builder, zen) {
        ...
        if (stack.hasAll('webpack') && !stack.hasAny('dll')) {
            ...
            if (stack.hasAny('server')) {
                createRule = function (ext, nodeModules, ruleList) { return ({
                    ...
                    exclude: function (modulePath) {
                        ...
                        return nodeModules ? moduleType <= resolveModule_1.ModuleType.ProjectModule : moduleType > resolveModule_1.ModuleType.ProjectModule;
                    },
                    use: [
                        { loader: 'isomorphic-style-loader', options: zen.createConfig(builder, 'isomorphicStyle', {}) },
                        { loader: 'css-loader', options: zen.createConfig(builder, 'css', __assign({}, loaderOptions)) }
                    ]
                        .concat(postCssLoader_1 && !nodeModules
                        ? {
                            loader: postCssLoader_1,
                            options: zen.createConfig(builder, 'postCss', useDefaultPostCss_1 ? __assign({}, postCssDefaultConfig(builder), loaderOptions) : __assign({}, loaderOptions))
                        }
                        : [])
                        .concat(ruleList)
                }); };
                        ...
                        return {
                            ...
                            use: dev
                                ? [
                                    ...
                                    {
                                        loader: 'css-loader',
                                        options: zen.createConfig(builder, 'css', __assign({}, loaderOptions, { importLoaders: 1 }))
                                    }
                                ]
                                    .concat(postCssLoader_1 && !nodeModules
                                    ? {
                                        loader: postCssLoader_1,
                                        options: zen.createConfig(builder, 'postCss', useDefaultPostCss_1
                                ...
                                : plugin_1.extract({
                                    ...
                                    use: [
                                        ...
                                        ? {
                                            loader: postCssLoader_1,
                                            options: zen.createConfig(builder, 'postCss', useDefaultPostCss_1 ? postCssDefaultConfig(builder) : {})
                                        }
                                        : [])
                                        .concat(ruleList
                        ...
                        return {
                            ...
                            use: dev
                                ? [
                                    ...
                                    .concat(ruleList)
                                : [
                                    { loader: ExtractCSSPlugin_2.loader, options: zen.createConfig(builder, 'mini-css-extract', {}) },
                                    {
                                        loader: 'css-loader',
                                        options: zen.createConfig(builder, 'css', {
                                            importLoaders: postCssLoader_1 && !nodeModules ? 1 : 0
            ...
            if (createRule && stack.hasAny('sass')) {
                var sassRule = [{ loader: 'sass-loader', options: zen.createConfig(builder, 'sass', __assign({}, loaderOptions)) }];
            ...
            if (createRule && stack.hasAny('less')) {
                ...
                var lessRule = [{ loader: 'less-loader', options: zen.createConfig(builder, 'less', options) }];
