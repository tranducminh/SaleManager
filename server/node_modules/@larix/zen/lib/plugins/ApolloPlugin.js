...
var ApolloPlugin = (function () {
    ...
    ApolloPlugin.prototype.configure = function (builder, zen) {
        var _a, _b;
        if (!builder.stack.hasAny('dll') && builder.stack.hasAll(['apollo', 'webpack'])) {
            var persistGraphQL = builder.persistGraphQL && !zen.test && !!builder.require.probe('persistgraphql-webpack-plugin');
            ...
            builder.config = zen.merge(builder.config, {
                module: {
                    rules: [
                        ...
                        {
                            test: /\.(graphql|gql)$/,
                            use: [{ loader: 'graphql-tag/loader', options: zen.createConfig(builder, 'graphqlTag', {}) }].concat(persistGraphQL ? ['persistgraphql-webpack-plugin/graphql-loader'] : [])
                        }
                    ]
                }
            });
